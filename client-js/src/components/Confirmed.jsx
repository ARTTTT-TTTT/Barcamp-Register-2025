...
function Confirmed({ user, Console }) {
	...
	return (
		<div className="w-full flex flex-col items-center justify-center">
			...
			<p className="mt-1 text-red-500 text-center text-[12px] mb-5">
				**ดาวน์โหลด QRCode นี้ เพื่อใช้ยืนยันตัวตนในวันร่วมงาน**
			</p>
			...
			{!voteOpen && (
				<button
					...
					className="text-white bg-primary-500 p-2 rounded-lg w-52 mt-5"
				>
					Download QRCode
				</button>
			)}
