...
import { SpecialRegister } from "../api/auth";
import ImageSlide from "../components/ImageSlide";

function SpecialRegisterPage() {
    return (
        <div className="relative h-screen">
            ...
            <div className="bg-white shadow-md w-full h-full flex flex-col items-center justify-center">
                ...
                >
                    ...
                    <p className="mb-5 text-primary-400 font-bold text-xl">ลงทะเบียนเข้าร่วมงาน เป็นกรณีพิเศษ</p>
